...
source "amazon-ebs" "firstrun-windows" {
  region        = "us-east-2"
  ami_name      = "packer-windows-server-core-${local.timestamp}"
  source_ami    = "ami-0d9abb859fc2d9951" # EC2LaunchV2-Windows_Server-2019-English-Core-Base-2023.12.13
  ...
  tags = {
    "Name" = "packer-windows-server-core"
